...
RSpec.describe Webhookable::Signature do
  ...
  describe ".generate" do
    ...
    it "raises SignatureError if payload is nil" do
      ...
      }.to raise_error(Webhookable::SignatureError, "Payload cannot be nil")
    end

    it "raises SignatureError if secret is nil" do
      expect {
        described_class.generate(payload_json, nil)
      }.to raise_error(Webhookable::SignatureError, "Secret cannot be nil")
    end
  ...
  describe ".verify" do
    ...
    it "raises SignatureError if signature is nil" do
      ...
      }.to raise_error(Webhookable::SignatureError, "Signature cannot be nil")
    end
